...
exports.connect = (host) => {
  ...
  // intentionally parallel initial pad creation request
  // this is for the experimental load balancer to create a
  // padId<>Backend association

  // If we notice connectivity issues or flakey balancing
  // this would be the place to make asnyc/await
  superagent.get(`${padState.host}/p/${padState.padId}`);
